...
BinaryPacker["prototype"] = {
    ...
    "getSize":     BinaryPacker_getSize, // BinaryPacker#getSize(source:Any, formatID:Integer):Integer
...
// --- implements ------------------------------------------
function BinaryPacker_getSize(source,     // @arg Any - source data
